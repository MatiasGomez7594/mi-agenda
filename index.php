...
<body>
  <div class="container-fluid row mt-5">
    ...
    <form class="needs-validation col-md " id="needs-validation">
      ...
      <div class="alert alert-success text-ok" id="message-signup">Registro exitoso</div>
      <div class="alert alert-danger text-error" id="error-signup">El email ya se encuentra registrado</div>
      ...
      <div class="form-row">
        <div class="col-md-6 mb-3">
          ...
          <div class="text-danger text-error" id="password-error">
        ...
        <div class="col-md-6 mb-3">
          ...
          <div class="text-danger text-error" id="password2-error">
      ...
      <div class="form-group">
        <div class="form-check">
          <input class="form-check-input " type="checkbox"  id="not-robot" >
          <label class="form-check-label" for="not-robot">
            No soy un robot
          </label>
          <div class="text-danger text-error" id="error-robot">
            ¿Sos un robot?
          </div>
        </div>
      </div>
