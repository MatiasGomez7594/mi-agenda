...
<body >
      ...
      <div class="menu-left" id="menu-left">
        ...
        if($search_contact){
          ...
          foreach ($search_contact as $contact_data){
            ...
            echo '<tr class="my-contact" onclick="activate_item('.$id_contact.')" id="contact'.$id_contact.'">';
    ...
    <form class="modal-footer" method="POST" action="edit_contact.php">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="modal-footer" method="POST" action="bbdd/delete_contact.php">
          ...
          <button type="submit" class="btn btn-success" id="delete">Aceptar</button>
        </form>
      </div>
    </div>
  </div>
  ...
  <script src="scripts/delete_edit_contact.js"></script>
