...
class Contact extends Connect{
    ...
    public function update($id_user,$id_contact,$contact_name,$contact_lastname,$phone_number,$adress,$email){
        $sql="UPDATE my_contacts SET contact_name = '$contact_name', contact_lastname = '$contact_lastname',
